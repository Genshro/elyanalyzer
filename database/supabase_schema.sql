...
INSERT INTO analysis_categories (name, display_name, description, icon) VALUES
('security', 'Security Analysis', 'Security vulnerabilities and best practices', '🔒'),
('code_quality', 'Code Quality', 'Code maintainability and SOLID principles', '🧪'),
('performance', 'Performance', 'Performance bottlenecks and optimization', '🚀'),
('compliance', 'Compliance', 'GDPR, HIPAA, PCI-DSS compliance checks', '⚖️'),
('accessibility', 'Accessibility', 'UX and accessibility standards (WCAG)', '♿'),
('documentation', 'Documentation', 'Code and API documentation quality', '📚'),
('testing', 'Testing', 'Test coverage and quality assurance', '🧪'),
('logging', 'Logging', 'Logging practices and observability', '📝'),
('architecture', 'Architecture', 'Design patterns, SOLID principles, and system architecture', '🏗️');
